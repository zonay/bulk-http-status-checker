...
export function generateHtmlReport(results: StatusCheckResult[]): string {
    return `
        <!DOCTYPE html>
        <html>
        <head>
...
function formatChainedStatus(urls: string[], statuses: string[]): string {
...
function formatUrlChain(chain: string[]): string {
